...
const TOKEN = "thr1.AAAAAF4lnKDfvEs7IEsxaA.CN0TKH7hk4I";
...
const ROOM = HBInit({ 
	...
	geo: { code: "kr", lat: 37.566667, lon: 126.3},					// 지역, 위도, 경도(대한민국 서울을 기준으로 기본값을 설정해 두었음)
	noPlayer : NOPLAYER										
});
...
class IoSystem{			
	constructor(){
		...
		this.SecurityPatchLevel		= "2020.01.16";		// UMUX 보안 패치 수준(건드리지 마시오)
