...
constructor() {
	...
	this.superBlacklist = [							// 슈퍼 블랙리스트 명단
		...
		// 명인만두 서울대점, 좁밥수비수
		"36312E37352E38332E3732", "36312E37352E38332E3732",
		// 쥐알티
	...
	this.blacklist = [ 								// 블랙리스트 명단
		...
		"와이어샤크", "핑폭각?", "Ready", "Bone Collecter", "GRF SWORD", "서든", "Preber", "프레버", "명인만두 서울대점", "좁밥수비수", "쥐알티", "겐류사이 육두봉", "반다이크",
		"경상도에서태어난아기를영국에서길렀더니내가나왔다", "soy el mas pro", "Ricardo", "drogba", "드록바", "HYNN", "루니", "제주스", "네테로"
	];
...
constructor(){
	...
	this.SecurityPatchLevel		= "2020.08.01c";	// UMUX 보안 패치 수준(건드리지 마시오)
